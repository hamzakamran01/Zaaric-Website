...
const GlobalCommerce = () => {
  ...
  useEffect(() => {
    ...
    const segments = isMobile ? 12 : 24; // Reduced segments for cleaner look
    ...
    // Enhanced lighting for white background
    const ambientLight = new THREE.AmbientLight(0xffffff, 0.8);
    scene.add(ambientLight);

    const pointLight = new THREE.PointLight(0x0072ff, 2);
    pointLight.position.set(5, 3, 5);
    scene.add(pointLight);

    const pointLight2 = new THREE.PointLight(0x00c6ff, 1.5);
